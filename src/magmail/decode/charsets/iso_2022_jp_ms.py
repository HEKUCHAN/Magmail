...
def decode(byte, error="strict"):
    ...
    byte_decoded = []
    decode_type = {"ascii": False, "katakana": False, "jis78": False, "jis90": False}
            ...
            if byte_1 == 0x1B:
                ...
                if (byte_1, byte_2) == (0x28, 0x42):
                    ...
                    raise UnicodeDecodeError(
                        f"Unknown escape suquence '{byte_1}{byte_2}'"
                    )
                ...
                if is_decode_type("ascii") and 0x00 <= byte_1 and byte_1 <= 0x7F:
                    ...
                    if (
                        ...
                        if joined_byte in jis78_target:
                            byte_decoded.append(jis78_map.get(joined_byte, 0x0000))
                        else:
                            byte_decoded.append(jis90_map.get(joined_byte, 0x0000))
